    ...
    <div className="pt-24 md:pt-32">
      ...
      <section className="px-6 md:px-16 container mx-auto max-w-4xl text-center py-20">
        <motion.h1 
          ...
          className="font-serif text-3xl md:text-5xl text-brand-white tracking-tight leading-[1.1] mb-6"
        >
        ...
        <motion.p
          ...
          className="font-sans text-base md:text-base text-brand-champagne/80 font-light max-w-2xl mx-auto"
        >
          Resultados obtenidos bajo mi dirección estratégica y el despliegue técnico de mi firma aliada.
        </motion.p>
      </section>
      ...
      <section className="py-20 px-6 md:px-16 container mx-auto max-w-4xl">
        <div className="space-y-16">
          ...
          {/* Caso 1 */}
          <div className="bg-brand-brown/30 border border-brand-taupe/15 rounded-2xl px-6 py-10 md:p-12">
            ...
            <div className="space-y-8 font-sans">
              <div className="border-l border-red-900/40 pl-4">
                ...
                <p className="text-base md:text-sm text-brand-champagne/80 font-light leading-relaxed">
              ...
              <div className="border-l border-green-900/40 pl-4 bg-brand-obsidian/30 py-3 pr-4 rounded-r-lg">
                ...
                <p className="text-base md:text-sm text-brand-white font-medium leading-relaxed">
                  Reducción del ciclo de ventas en 14 días. Tasa de cierre aumentada en un 35%. Dos contratos empresariales asegurados en el Q1 sin objeciones de precio, generando un ROI de 1,200% sobre mi intervención.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-brand-brown/20 border-t border-brand-taupe/10 relative">
        <div className="px-6 md:px-16 container mx-auto max-w-4xl text-center">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="font-serif text-xl md:text-2xl text-brand-white italic leading-relaxed mb-8">
